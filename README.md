...
It then sorts the 3 by ascending order and pushes the numbers in stack B back to stack A.
...
Then it shifts one position to the right and does the described pusing and rotating again.
